...
def handle_send_message_event(data):
    ...
    line_bot_api.push_message(data['customerID'], TextSendMessage(text=data['message']))
    save_message(message=data["message"],message_type="text",sender=bot_define['bot_name'],sender_id=ObjectId(data['botID']),sender_type="bot",room=data['botID']+'&'+data['customerID'])
    socketio.emit("message_from_response", {"message":data['message'],"message_type":"text", "userID":data['customerID'], "botID":str(bot_define['_id']),"pictureUrl":server_url+'images/bot/bot_pic/'+bot_define['Img'],"displayName":bot_define['bot_name'],"type":"bot"},room=data['room'])
        ...
        if request.method == "GET":
            ...
            if sender_define['status'] == 'open' :
                if message_type == 'text':
                    ...
                    socketio.emit("message_from_webhook", {"message":data["message"],"message_type":"text", "userID":sender_define['userID'], "botID":str(bot_define['_id']),"pictureUrl":profile.picture_url,"sender":profile.display_name,"type":"customer"},room=botID+'&'+sender_define['userID'])
                    ...
                    socketio.emit("message_from_webhook", {"message":"unavailable to show content","message_type":"text", "userID":sender_define['userID'], "botID":str(bot_define['_id']),"pictureUrl":profile.picture_url,"sender":profile.display_name,"type":"customer"},room=botID+'&'+sender_define['userID'])
                    res = {"message":"ขอโทษครับ ผมรับเป็นตัวหนังสือเท่านั้น"}
                ...
                if "message" in res.keys():
                    ...
                    socketio.emit("message_from_response", {"message":res['message'],"message_type":"text", "userID":sender_define['userID'], "botID":str(bot_define['_id']),"pictureUrl":server_url+'images/bot/bot_pic/'+bot_define['Img'],"sender":bot_define['bot_name'],"type":"bot"},room=botID+'&'+sender_define['userID'])
                    ...
                    socketio.emit("message_from_response", {"message":"unavailable to show content","message_type":"flex", "userID":sender_define['userID'], "botID":str(bot_define['_id']),"pictureUrl":server_url+'images/bot/bot_pic/'+bot_define['Img'],"sender":bot_define['bot_name'],"type":"bot"},room=botID+'&'+sender_define['userID'])
                    save_message(message="unavailable to show content",message_type="flex",sender=bot_define['bot_name'],sender_id=ObjectId(botID),sender_type="bot",room=botID+'&'+sender_define['userID'])
                elif 'image' in res.keys():
                    response = ImageSendMessage(
                        original_content_url=res['image'],
                        preview_image_url=res['image']
                    )
                    socketio.emit("message_from_response", {"ImageURL":res['image'],"message_type":"image", "userID":sender_define['userID'], "botID":str(bot_define['_id']),"pictureUrl":server_url+'images/bot/bot_pic/'+bot_define['Img'],"sender":bot_define['bot_name'],"type":"bot"},room=botID+'&'+sender_define['userID'])
                    ...
                    socketio.emit("message_from_response", {"message":"unavailable to show content","message_type":"text", "userID":sender_define['userID'], "botID":str(bot_define['_id']),"pictureUrl":server_url+'images/bot/bot_pic/'+bot_define['Img'],"sender":bot_define['bot_name'],"type":"bot"},room=botID+'&'+sender_define['userID'])
                    save_message(message="unavailable to show content",message_type="text",sender=bot_define['bot_name'],sender_id=ObjectId(botID),sender_type="bot",room=botID+'&'+sender_define['userID'])

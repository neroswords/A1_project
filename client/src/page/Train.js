...
function Train(props){
    ...
    const add_data = (data) =>{
        ...
        console.log(deleteState[0].Word)
    }
            ...
            <div className="container">
                <div className="container-top d-flex bd-highlight">
                    ...
                    <div className="p-2 bd-highlight">
                        ...
                        <DeleteModal dataType={'training'} dataID={props.match.params.bot_id} delete_trained={delete_trained} add_data={add_data} />
                    </div>
                    <div className="p-2 bd-highlight">
                ...
                <hr></hr>
                <Tablecon botID = {props.match.params.bot_id} delete_trained={delete_trained} add_data={add_data} />
            </div>
